...
$ssql = "select * from compras where clave='$clave'"; 
$consulta = mysqli_query($conn,$ssql);  
while(@$fila = mysqli_fetch_array($consulta)) {  
 
$clave=$clave; 
$_S["tipo"]=$fila["tipo"]; 
$_S["precio"]=$fila["precio"]; 
$_S["ciudad"]=$fila["ciudad"]; 
$_S["pais"]=$fila["pais"]; 
$_S["dimension"]=$fila["dimension"];
$_S["descripcion"]=$fila["descripcion"]; 
...
<div align="center">
        ...
        <form >
                ...
                <tr><td>Clave:</td>
                <td><input type="text" name="clave" id="idclave" style="width:160px" value="<?php echo  $clave;?>"></td></tr>
                <tr><td>Tipo:</td>
                ...
                <tr><td>Precio $:</td>
                    <td><input type="text" name="precio" id="idprecio" placeholder="Ingrese precio en dls" style="width:160px" value="<?php echo  $_SESSION['precio'];?>"></td></tr>
                <tr><td>Ciudad:</td>
                    <td><input type="text" name="ciudad" id="idciudad" placeholder="Ingrese ciudad de ubicación" style="width:160px" value="<?php echo  $_SESSION['ciudad'];?>"></td></tr>
                <tr><td>Pais:</td>
                    <td><input type="text" name="pais" id="idpais" placeholder="Ingrese pais de ubicación" style="width:160px" value="<?php echo  $_SESSION['pais'];?>"></td></tr>
                <tr><td>Dimensión:</td>
                    <td><input type="text" name="dimension" id="iddimension" placeholder="Ingrese dimensiones en m2" style="width:160px" value="<?php echo  $_SESSION['dimension'];?>"></td></tr>
                <tr><td>Descripcion:</td>
                    <td><textarea type="text" name="descripcion" id="iddescripcion" placeholder="Ingrese una breve descripcion menor a 150 caracteres" style="width:160px;height: 100px" value="<?php echo  $_SESSION['descripcion'];?>"></textarea></td></tr>
                <tr><td></td>            
                </th></table>
...
<script type ="text/javascript">
    ...
    <div id=""#htmlexterno"> AQUI HTML</div>
